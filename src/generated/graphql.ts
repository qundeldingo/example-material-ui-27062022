...
export type TesQueryVariables = Exact<{
  id: Scalars['uuid'];
}>;


export type TesQuery = { __typename?: 'query_root', tes?: { __typename?: 'test', id: any, name: string } | null };

export type TestQueryVariables = Exact<{
  distinct_on?: InputMaybe<Array<Test_Select_Column> | Test_Select_Column>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<Test_Order_By> | Test_Order_By>;
  where?: InputMaybe<Test_Bool_Exp>;
}>;


export type TestQuery = { __typename?: 'query_root', test: Array<{ __typename?: 'test', id: any, name: string }> };

export type InsertTesMutationVariables = Exact<{
  test: Test_Insert_Input;
  on_conflict?: InputMaybe<Test_On_Conflict>;
}>;


export type InsertTesMutation = { __typename?: 'mutation_root', insertTes?: { __typename?: 'test', id: any, name: string } | null };

export type InsertTestMutationVariables = Exact<{
  test: Array<Test_Insert_Input> | Test_Insert_Input;
  on_conflict?: InputMaybe<Test_On_Conflict>;
}>;


export type InsertTestMutation = { __typename?: 'mutation_root', insertTest?: { __typename?: 'test_mutation_response', returning: Array<{ __typename?: 'test', created_at: any, id: any, is_deleted: boolean, name: string, updated_at: any }> } | null };

export type UpdateTesMutationVariables = Exact<{
  test?: InputMaybe<Test_Set_Input>;
  pk_columns: Test_Pk_Columns_Input;
}>;


export type UpdateTesMutation = { __typename?: 'mutation_root', updateTes?: { __typename?: 'test', id: any, name: string } | null };
...
export type UpdateTestMutation = { __typename?: 'mutation_root', updateTest?: { __typename?: 'test_mutation_response', returning: Array<{ __typename?: 'test', created_at: any, id: any, is_deleted: boolean, name: string, updated_at: any }> } | null };

export type Tes_TestFragment = { __typename?: 'test', id: any, name: string };

export type Test_TestFragment = { __typename?: 'test', id: any, name: string };

export type InsertTes_TestFragment = { __typename?: 'test', id: any, name: string };

export type InsertTest_Test_Mutation_ResponseFragment = { __typename?: 'test_mutation_response', returning: Array<{ __typename?: 'test', created_at: any, id: any, is_deleted: boolean, name: string, updated_at: any }> };

export type UpdateTes_TestFragment = { __typename?: 'test', id: any, name: string };

export type UpdateTest_Test_Mutation_ResponseFragment = { __typename?: 'test_mutation_response', returning: Array<{ __typename?: 'test', created_at: any, id: any, is_deleted: boolean, name: string, updated_at: any }> };
...
export const Update_Customers_By_Pk_CustomersFragmentDoc = gql`
  ...
  date_of_birth
    ...
    `;
export const Tes_TestFragmentDoc = gql`
    fragment tes_test on test {
  id
  name
}
    `;
export const Test_TestFragmentDoc = gql`
    fragment test_test on test {
  id
  name
}
    `;
export const InsertTes_TestFragmentDoc = gql`
    fragment insertTes_test on test {
  id
  name
}
    `;
export const InsertTest_Test_Mutation_ResponseFragmentDoc = gql`
  ...
  returning {
    ...
    `;
export const UpdateTes_TestFragmentDoc = gql`
    fragment updateTes_test on test {
  id
  name
}
    `;
export const UpdateTest_Test_Mutation_ResponseFragmentDoc = gql`
...
export function useTesQuery(options: Omit<Urql.UseQueryArgs<TesQueryVariables>, 'query'>) {
  return Urql.useQuery<TesQuery>({ query: TesDocument, ...options });
};
...
export const InsertTesDocument = gql`
    mutation insertTes($test: test_insert_input!, $on_conflict: test_on_conflict) {
  insertTes(object: $test, on_conflict: $on_conflict) {
    ...insertTes_test
  }
}
    ${InsertTes_TestFragmentDoc}`;

export function useInsertTesMutation() {
  return Urql.useMutation<InsertTesMutation, InsertTesMutationVariables>(InsertTesDocument);
};
export const InsertTestDocument = gql`
  ...
  insertTest(objects: $test, on_conflict: $on_conflict) {
    ...
    ${InsertTest_Test_Mutation_ResponseFragmentDoc}`;

export function useInsertTestMutation() {
  return Urql.useMutation<InsertTestMutation, InsertTestMutationVariables>(InsertTestDocument);
};
export const UpdateTesDocument = gql`
    mutation updateTes($test: test_set_input, $pk_columns: test_pk_columns_input!) {
  updateTes(_set: $test, pk_columns: $pk_columns) {
    ...updateTes_test
  }
}
    ${UpdateTes_TestFragmentDoc}`;

export function useUpdateTesMutation() {
  return Urql.useMutation<UpdateTesMutation, UpdateTesMutationVariables>(UpdateTesDocument);
};
export const UpdateTestDocument = gql`
  ...
  updateTest(_set: $test, where: $where) {
    ...
    ${UpdateTest_Test_Mutation_ResponseFragmentDoc}`;

export function useUpdateTestMutation() {
  return Urql.useMutation<UpdateTestMutation, UpdateTestMutationVariables>(UpdateTestDocument);
};